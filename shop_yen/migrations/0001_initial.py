# Generated by Django 2.1.7 on 2019-04-13 13:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('note', models.CharField(blank=True, max_length=255, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('timestamp', models.IntegerField(default=1555163961, help_text='Thời gian cuối cùng kiểm kê kho')),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('modified_date', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('marketplace_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='shop_yen.Marketplace')),
                ('done_at', models.DateTimeField(auto_now_add=True)),
            ],
            bases=('shop_yen.marketplace',),
        ),
        migrations.AddField(
            model_name='price',
            name='product',
        ...
        migrations.AlterUniqueTogether(
            name='provider',
            unique_together={('name', 'phone'), ('name', 'facebook'), ('name', 'email'), ('name', 'zalo'), ('name', 'mobile')},
        ),
        migrations.AlterUniqueTogether(
            name='product',
